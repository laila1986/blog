...
knitr::kable(data.frame(Name=c("Rafael"),Spoken_Languages=c("Spanish","English")),caption = "Table A.")
knitr::kable(data.frame(Name=c("Rafael"),Computer_Languages=c("R","SAS","Javacript","HTML","...SQL?")), caption = "Table B.")
```
